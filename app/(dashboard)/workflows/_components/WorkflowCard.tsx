...
const WorkflowCard = ({workflow} : {workflow: Workflow}) => {
    ...
    return (
        <Card className="border border-seperate shadow-sm rounded-lg overflow-hidden hover:shadow-md dark:shado-primary/30">
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant={"outline"} size={"sm"}>
                    <TooltipWrapper side="left" content={"More Actions"}>
